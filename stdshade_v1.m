function [lineOut, fillOut] = stdshade_v1(amatrix,alpha,acolor,displayname,smth,F)
...
hold on;
lineOut = plot(F,amean, 'color', acolor,'linewidth',1.5, 'DisplayName',displayname); %% change color or linewidth to adjust mean line
if check
    hold off;
end
end
