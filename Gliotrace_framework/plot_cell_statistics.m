function plot_cell_statistics(cell_stats, celline, perturbation, dose)
...
idx = cellfun(@(x) ischar(x) && contains(x, perturbation) && contains(x,celline) && contains(x,[num2str(dose) ' uM']), cell_stats.info);
