function plot_transition_hierarchy_full(transition_matrix, state_names, show_number)
...
min_thickness = 1;
max_thickness = max(transition_matrix(:))/100; % Maximum thickness for the edges
...
h.NodeLabel = state_names;  % Use remaining state names for the nodes
...
h.MarkerSize = 25; % Increase the size of the node markers
end